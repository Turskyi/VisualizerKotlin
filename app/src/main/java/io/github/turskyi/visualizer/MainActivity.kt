    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == MY_PERMISSION_RECORD_AUDIO_REQUEST_CODE) {
            ...
            if (grantResults.isNotEmpty()
                ...
                mAudioInputReader =
                    mVisualizerView?.let { AudioInputReader(it, this) }
            } else {
                Toast.makeText(
                    this,
    ...
    override fun onSharedPreferenceChanged(
        ...
        when (key) {
            ...
            getString(R.string.pref_color_key) -> {
                sharedPreferences?.let { loadColorFromPreferences(it) }
            }

            getString(R.string.pref_size_key) -> {
                sharedPreferences?.let { loadSizeFromSharedPreferences(it) }
            }
        }
    }
